...
<<<<<<< HEAD
    ...
    try {
      ...
      setAnalysisData({
        ...
        frameAnalysis: result.frame_scores.map(
          ...
          ...(result.confidence > 50 ? [
            {
              ...
              region: "Audio Track",
              description: "Voice synthesization artifacts detected in frequency spectrum",
            },
            {
              id: 3,
              type: "Temporal Inconsistency",
              timestamp: 8.2,
              confidence: Math.min(result.confidence * 1.05, 99),
              region: "Face - Mouth",
              description: "Lip-sync misalignment detected with audio track",
            },
          ] : []),
        ],
=======
...
>>>>>>> 3fbaee749280c97cd3e0dc6d980e1db0639f610d
        technicalDetails: {
          duration: "15s",
          resolution: "1080p",
          fps: 30,
          codec: "H.264",
          processingTime: "Real-time EfficientNet",
        },
<<<<<<< HEAD
      });
    } catch (err) {
